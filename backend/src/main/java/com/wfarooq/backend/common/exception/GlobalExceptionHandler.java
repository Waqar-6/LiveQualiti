...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleGlobalException (WebRequest webRequest, Exception e) {
    ...
    public ResponseEntity<ErrorResponseDto> handleBadRequestException(WebRequest webRequest, BadRequestException e) {
    ...
    public ResponseEntity<ErrorResponseDto> handleResourceAlreadyExistsException (WebRequest webRequest, ResourceAlreadyExistsException e) {
